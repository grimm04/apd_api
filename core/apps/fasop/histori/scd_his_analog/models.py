...
class SCD_HIS_ANALOG(models.Model):
    id = models.AutoField(primary_key=True) 
    point_number = models.ForeignKey(
        CPoint, default=None, on_delete=models.CASCADE, blank=True, null=True, db_column='point_number', related_name='analog_his'
    )
    ...
    @property
    def path1(self):
        return self.point_number.path1

    class Meta:
        managed = True
        db_table = 'scd_his_analog'
...
EXPORT_FIELDS = ['id', 'pointtype_name', 'path1text', 'path2text','path3text','datum_1','statekey_1','status_1','datum_2','statekey_2','status_2','datum_capture','kesimpulan']
EXPORT_RELATION_FIELD = [
            {'c_point':['point_name','point_type','path1','path2','path3','path4','path5','path1text','path2text','path3text','path4text','path5text','pointtype_name']}, 
        ] 