...
class SCD_HIS_DIGITAL(models.Model):
    id = models.AutoField(primary_key=True) 
    point_number = models.ForeignKey(
        CPoint, default=None, on_delete=models.CASCADE, blank=True, null=True, db_column='point_number', related_name='digital_his'
    )
...
EXPORT_RELATION_FIELD = [
            {'c_point':['point_name','pointtype_name','path1text','path2text','path3text','path4text']}, 
        ] 