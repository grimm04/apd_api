...
class SCD_HIS_MESSAGESerializers(serializers.ModelSerializer): 
    ...
    time_stamp = serializers.DateTimeField(format="%Y-%m-%d %H:%M:%S" ,default=None) 
    system_time_stamp = serializers.DateTimeField(format="%Y-%m-%d %H:%M:%S" ,default=None)  
