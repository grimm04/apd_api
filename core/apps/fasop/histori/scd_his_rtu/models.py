...
class SCD_HIS_RTU(models.Model):
    id = models.AutoField(primary_key=True) 
    point_number = models.ForeignKey(
        RTU, default=None, on_delete=models.CASCADE, blank=True, null=True, db_column='point_number', related_name='rtu_his'
    )
    ...
    durasi = models.CharField(max_length=100, db_collation='SQL_Latin1_General_CP1_CI_AS')  
    jenis_rtu = models.CharField(max_length=100, db_collation='SQL_Latin1_General_CP1_CI_AS')  

    class Meta:
        managed = True
        db_table = 'scd_his_rtu'
...
EXPORT_FIELDS = ['id', 'pointtype_name', 'path3text','datum_1','statekey_1','status_1','datum_2','statekey_2','status_2','datum_capture','kesimpulan']
