...
class SCD_KIN_ANALOG_BULAN(models.Model):
    id_kin_analog_bulan = models.AutoField(primary_key=True)  
    ...
    class Meta:
        managed = True
        db_table = 'scd_kin_analog_bulan'

    def __str__(self):
        return self.id_kin_analog_bulan 

EXPORT_HEADERS = ['id_kin_analog_bulan','b1', 'b2','b3', 'element','up','down', 'downtime','uptime','performance','faktor']
EXPORT_FIELDS = ['id_kin_analog_bulan','up','up','up','up', 'up','down', 'downtime','uptime','performance','faktor']
