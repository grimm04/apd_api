...
class SCD_KIN_DIGITAL_BULAN(models.Model):
    id_kin_digital_bulan = models.AutoField(primary_key=True)  
    ...
    class Meta:
        managed = True
        db_table = 'scd_kin_digital_bulan'

    def __str__(self):
        return self.id_kin_digital_bulan 

EXPORT_HEADERS = ['id_kin_digital_bulan', 'up','down', 'downtime','uptime','performance','faktor']
EXPORT_FIELDS = ['id_kin_digital_bulan', 'up','down', 'downtime','uptime','performance','faktor']
