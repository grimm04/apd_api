...
class SCD_KIN_DIGITAL_HARI(models.Model):
    id_kin_digital_harian = models.AutoField(primary_key=True)  
    ...
    class Meta:
        managed = True
        db_table = 'scd_kin_digital_harian'

    def __str__(self):
        return self.id_kin_digital_harian 

EXPORT_HEADERS = ['id_kin_digital_harian', 'up','down', 'downtime','uptime','performance','faktor']
EXPORT_FIELDS = ['id_kin_digital_harian', 'up','down', 'downtime','uptime','performance','faktor']
