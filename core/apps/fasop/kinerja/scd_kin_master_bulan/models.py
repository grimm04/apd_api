...
class SCD_KIN_MASTER_BULAN(models.Model):
    id_kin_master_bulan = models.AutoField(primary_key=True)  
    ...
    class Meta:
        managed = True
        db_table = 'scd_kin_master_bulan'

    def __str__(self):
        return self.id_kin_master_bulan 

EXPORT_HEADERS = ['id_kin_master_bulan', 'up','down', 'downtime','uptime','performance','faktor']
EXPORT_FIELDS = ['id_kin_master_bulan', 'up','down', 'downtime','uptime','performance','faktor']
