...
from .models import SCD_KIN_RTU_BULAN  
 
        
class SCD_KIN_RTU_BULANSerializers(serializers.ModelSerializer):  
    ...
    c_point = RTUTypeSerializer(read_only=True, source='point_number')

    class Meta:
        model = SCD_KIN_RTU_BULAN
        fields = '__all__'
