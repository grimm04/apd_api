...
class SCD_ANALOG_RTL(models.Model):
    id = models.AutoField(primary_key=True) 
    point_number = models.ForeignKey(
        CPoint, default=None, on_delete=models.CASCADE, blank=True, null=True, db_column='point_number', related_name='analog'
    )
...
EXPORT_RELATION_FIELD = [
            {'c_point':['point_name','point_type','path1','path2','path3','path4','path5','path1text','path2text','path3text','path4text','path5text']}, 
        ] 