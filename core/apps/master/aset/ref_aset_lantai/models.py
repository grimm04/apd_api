...
class RefAsetLantai(models.Model):
    ...
    id_ref_aset_lantai = models.AutoField(primary_key=True, db_column='id_ref_aset_lantai')
    ...
    class Meta:
        managed = False
        db_table = 'ref_aset_lantai'

    def __str__(self):
        return self.id_ref_aset_lantai


EXPORT_HEADERS = ['id_ref_aset_lantai', 'nama', 'status','tanggal_buat','tanggal_ubah']
EXPORT_FIELDS = ['id_ref_aset_lantai', 'nama', 'status','tgl_entri','tgl_update']
