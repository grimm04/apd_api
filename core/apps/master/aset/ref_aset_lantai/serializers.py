...
class RefAsetLantaiSerializersList(serializers.ModelSerializer):
    # user_entri = UserDetailSerializerDef(read_only=True, source='id_user_entri')
    class Meta:
        model = RefAsetLantai
        fields = '__all__'
        
class CRRefAsetLantaiSerializers(serializers.ModelSerializer):
...
class UDRefAsetLantaiSerializers(serializers.ModelSerializer):
