...
class RefAsetLevel(models.Model):
    ...
    id_ref_aset_level = models.AutoField(primary_key=True, db_column='id_ref_aset_level')
    ...
    class Meta:
        managed = False
        db_table = 'ref_aset_level'

    def __str__(self):
        return self.id_ref_aset_level

EXPORT_HEADERS = ['id_ref_aset_level', 'nama', 'status','tanggal_buat','tanggal_ubah']
EXPORT_FIELDS = ['id_ref_aset_level', 'nama', 'status','tgl_entri','tgl_update']
