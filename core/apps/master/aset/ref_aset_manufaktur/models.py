...
class RefAsetManufaktur(models.Model):
    ...
    id_ref_aset_manufaktur = models.AutoField(primary_key=True, db_column='id_ref_aset_manufaktur')
    ...
    class Meta:
        managed = False
        db_table = 'ref_aset_manufaktur'

    def __str__(self):
        return self.id_ref_aset_manufaktur

EXPORT_HEADERS = ['id_ref_aset_manufaktur', 'nama', 'status','tanggal_buat','tanggal_ubah']
EXPORT_FIELDS = ['id_ref_aset_manufaktur', 'nama', 'status','tgl_entri','tgl_update']
