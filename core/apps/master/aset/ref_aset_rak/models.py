...
class RefAsetRak(models.Model):
    ...
    id_ref_aset_rak = models.AutoField(primary_key=True, db_column='id_ref_aset_rak')
    ...
    class Meta:
        managed = False
        db_table = 'ref_aset_rak'

    def __str__(self):
        return self.id_ref_aset_rak


EXPORT_HEADERS = ['id_ref_aset_rak', 'nama', 'status','tanggal_buat','tanggal_ubah']
EXPORT_FIELDS = ['id_ref_aset_rak', 'nama', 'status','tgl_entri','tgl_update']
