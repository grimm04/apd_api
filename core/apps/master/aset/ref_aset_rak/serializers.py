...
class RefAsetRakSerializersList(serializers.ModelSerializer):
    # user_entri = UserDetailSerializerDef(read_only=True, source='id_user_entri')
    class Meta:
        model = RefAsetRak
        fields = '__all__'

class CRRefAsetRakSerializers(serializers.ModelSerializer):
...
class UDRefAsetRakSerializers(serializers.ModelSerializer):
