...
class RefAsetRuangan(models.Model):
    ...
    id_ref_aset_ruangan = models.AutoField(primary_key=True, db_column='id_ref_aset_ruangan')
    ...
    class Meta:
        managed = False
        db_table = 'ref_aset_ruangan'

    def __str__(self):
        return self.id_ref_aset_ruangan

EXPORT_HEADERS = ['id_ref_aset_ruangan', 'nama', 'status','tanggal_buat','tanggal_ubah']
EXPORT_FIELDS = ['id_ref_aset_ruangan', 'nama', 'status','tgl_entri','tgl_update']
