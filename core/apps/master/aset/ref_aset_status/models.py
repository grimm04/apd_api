...
class RefAsetStatus(models.Model):
    ...
    id_ref_aset_status = models.AutoField(primary_key=True, db_column='id_ref_aset_status')
    ...
    class Meta:
        managed = False
        db_table = 'ref_aset_status'

    def __str__(self):
        return self.id_ref_aset_status

# EXPORT_HEADERS = ['id_ref_aset_status', 'nama', 'status','id_user_entri','id_user_update','tgl_entri','tgl_update','user_update']
# EXPORT_FIELDS = ['id_ref_aset_status', 'nama', 'status','id_user_entri','id_user_update','tgl_entri','tgl_update','fullname']
EXPORT_HEADERS = ['id_ref_aset_status', 'nama', 'status','tanggal_buat','tanggal_ubah']
EXPORT_FIELDS = ['id_ref_aset_status', 'nama', 'status','tgl_entri','tgl_update']
EXPORT_RELATION_FIELD = [
            # {'user_entri':['username','email','fullname']},
            # {'user_update':['username','email','fullname']},
        ] 