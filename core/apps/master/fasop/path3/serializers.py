...
class FASOPPATH3Serializers(serializers.ModelSerializer):
    path1 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    path2 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    path3 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
...
class CRFASOPPATH3CSerializers(serializers.ModelSerializer):
    path1 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    path2 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    path3 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    status = serializers.IntegerField(default=None, allow_null=True)
...
class UDFASOPPATH3Serializers(serializers.ModelSerializer):
    path1 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    path2 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    path3 = serializers.CharField(max_length=255, default=None, allow_blank=True, allow_null=True)
    status = serializers.IntegerField(default=None, allow_null=True)
