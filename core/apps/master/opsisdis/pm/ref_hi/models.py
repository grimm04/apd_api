...
class RefHI(models.Model):
    ...
    id_ref_hi = models.AutoField(primary_key=True, db_column='id_ref_hi')
    nama = models.CharField(max_length=100, db_collation='SQL_Latin1_General_CP1_CI_AS') 
    bobot_awal = models.IntegerField(blank=True, null=True, default=None)
    bobot_akhir = models.IntegerField(blank=True, null=True, default=None) 
