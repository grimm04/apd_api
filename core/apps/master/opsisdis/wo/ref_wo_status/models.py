...
class RefWOStatus(models.Model):
    ...
    id_ref_wo_status = models.AutoField(primary_key=True, db_column='id_ref_wo_status')
    ...
    class Meta:
        managed = False
        db_table = 'ref_wo_status'

    def __str__(self):
        return self.id_ref_wo_status