...
from .models import TransTmSubsistemBulan  
...
class TransTmSubsistemBulanSerializers(serializers.ModelSerializer):   
    ...
    class Meta:
        model = TransTmSubsistemBulan
        fields = '__all__'

class LaporanBebanSubSistemBulanPDFSerializers(serializers.ModelSerializer):    
