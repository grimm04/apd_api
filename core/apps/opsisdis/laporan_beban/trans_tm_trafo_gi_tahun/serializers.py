...
class TransTmTrafoGiTahunSerializers(serializers.ModelSerializer): 
    ...
    load_faktor = serializers.DecimalField(max_digits=18, decimal_places=2, allow_null=True, required=False) 
    ...
    v_kurang_202kv = serializers.DecimalField(max_digits=18, decimal_places=2, allow_null=True, required=False)
    v_lebih_207kv = serializers.DecimalField(max_digits=18, decimal_places=2, allow_null=True, required=False)
    v_max = serializers.DecimalField(max_digits=18, decimal_places=2, allow_null=True, required=False)
    v_min = serializers.DecimalField(max_digits=18, decimal_places=2, allow_null=True, required=False)
    ...
    v_avg = serializers.DecimalField(max_digits=18, decimal_places=2, allow_null=True, required=False)
    ...
    date_hari = serializers.DateTimeField(read_only=True, source='datum', format="%Y")  
...
class LaporanBebanTrafoGiTahunPDFSerializers(serializers.ModelSerializer):    
