...
class TransTmUidBulan(models.Model):
    id_trans_tm_uid_bulan = models.AutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'trans_tm_uid_bulan'
    
    def __str__(self):
        return self.id_trans_tm_uid_bulan 
...
EXPORT_HEADERS_HARIAN = [{
    ...
    'header_row_start': 5,
    'data': [
        {'name': 'Laporan Beban Tegangan UID PerBulan', 'column': 'A1:J1', 'width': 15, 'merge': True,'align':'center','type':'row'},
