...
class TransTmUp2BHari(models.Model):
    id_trans_tm_up2b_hari = models.AutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'trans_tm_up2b_hari'
    
    def __str__(self):
        return self.id_trans_tm_up2b_hari 
...
EXPORT_HEADERS_HARIAN = [{
    ...
    'header_row_start': 5,
    'data': [
        {'name': 'Laporan Beban Tegangan UP2B PerHari', 'column': 'A1:J1', 'width': 15, 'merge': True,'align':'center','type':'row'},
