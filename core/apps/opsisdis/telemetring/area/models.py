...
EXPORT_HEADERS = ['Datetime',  'Parent Lokasi', 'Area', 'Arus (A)', 'Tegangan (kV)', 'Daya Aktif (MW)', 'Daya Reaktif (MVAR)']
...
class TelemetringArea(models.Model):
    id_trans_tm_area = models.AutoField(primary_key=True)
    ...
    class Meta:
        managed = True
        db_table = 'trans_tm_area'

    def __str__(self):
        return self.id_trans_tm_area