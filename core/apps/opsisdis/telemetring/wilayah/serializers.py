...
from .models import TelemetringWilayah
...
@extend_schema_serializer(
    exclude_fields=('id_trans_tm_wilayah', 'tgl_entri', 'tgl_update'),
    examples=[
         OpenApiExample(
            'Batch Example',
...
class TelemetringWilayahSerializers(serializers.ModelSerializer):
...
class UDTelemetringWilayahSerializers(serializers.ModelSerializer):
    i = serializers.IntegerField(default=None, allow_null=True)
    v = serializers.IntegerField(default=None, allow_null=True)
    p = serializers.IntegerField(default=None, allow_null=True)
    q = serializers.IntegerField(default=None, allow_null=True)
