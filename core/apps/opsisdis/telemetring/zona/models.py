...
EXPORT_HEADERS = ['Datetime', 'Penyulang', 'Zona', 'Arus (A)', 'Tegangan (kV)', 'Daya Aktif (MW)', 'Daya Reaktif (MVAR)', 'Frekwensi (HZ)']
EXPORT_FIELDS = ['datum', 'nama_parent_lokasi', 'nama_lokasi', 'i', 'v', 'p', 'q', 'f']
...
class TelemetringZona(models.Model):
    id_trans_tm_zona = models.AutoField(primary_key=True)
    ...
    class Meta:
        managed = True
        db_table = 'trans_tm_zona'

    def __str__(self):
        return self.id_trans_tm_zona